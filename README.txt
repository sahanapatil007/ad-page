buildabo ad landing page
========================

This folder is a standalone copy of the ad page. Zip it and send it, or upload the whole folder to any static host (Netlify, Vercel, GitHub Pages, or your server).
